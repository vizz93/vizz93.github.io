...
/**
  * Mobile burger menu (toggles the header nav dropdown)
  */
$('#header-burger').on('click', function () {
	$(this).toggleClass('is-open');
	$('#site-nav-wrap').toggleClass('is-open');
	$('#header-burger').attr('aria-expanded', $(this).hasClass('is-open'));
});

$('.site-nav__list a').on('click', function () {
	$('#header-burger').removeClass('is-open').attr('aria-expanded', 'false');
	$('#site-nav-wrap').removeClass('is-open');
});

$(document).on('click', function (e) {
	if (!$(e.target).closest('#header-burger, #site-nav-wrap').length) {
		$('#header-burger').removeClass('is-open').attr('aria-expanded', 'false');
		$('#site-nav-wrap').removeClass('is-open');
	}
});
